...
DEFAULT_PR_AI_MODEL: Final[str] = get_env(
    "GIT_ACP_PR_AI_MODEL", "qwen2.5:3b-instruct"
)  # Larger model for PR descriptions
...
DEFAULT_PR_AI_CONTEXT_TYPE: Final[str] = get_env(
    "GIT_ACP_PR_AI_CONTEXT_TYPE", "both"
)  # Options: "commits", "diffs", or "both"
