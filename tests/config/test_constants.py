...
class TestConstants:
    ...
    @pytest.mark.parametrize("env_var, constant, default, cast_type", [
    ...
    def test_environment_overrides(self, monkeypatch, env_var, constant, default, cast_type):
    ...
    @pytest.mark.parametrize("width_env, expected", [
        ('80', 80),
