...
class TestCli(unittest.TestCase):
    ...
    @patch('glob.glob')
    def test_cli_add_path_has_changes(self, mock_glob, mock_git_add, mock_get_changed_files_git_module,
        ...
        with patch('git_acp.cli.cli.get_current_branch') as mock_get_current_branch:
            ...
            self.runner.invoke(main, ['-a', 'folder/*.py', '-o', '--no-confirm', '--verbose'])
    ...
    @patch('git_acp.cli.cli.git_add')
    @patch('glob.glob')
    def test_cli_add_path_no_changes(self, mock_glob, mock_git_add, mock_get_changed_files_git_module,
                                     mock_generate_commit_message, mock_git_commit,
                                     mock_git_push, mock_sys_exit):
        ...
        self.assertIn("didnotmatchanyfilesystempaths:folder/*.py", "".join(result.output.split()))
